...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'john@example.com', description: 'Email address (must be unique)' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'securePassword123', description: 'Password (min 6 characters)', minLength: 6 }),
    (0, class_validator_1.IsString)(),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        ...
        example: role_entity_1.RoleType.USER,
        description: 'User role (USER, ADMIN, SUPER_ADMIN). Defaults to USER.',
        default: role_entity_1.RoleType.USER
    }),
